...
$.validity = {
    ...
    messages:{
        ...
        // Format validators:
        match:"#{field} tiene un formato invalido.",
        integer:"#{field} must be a positive, whole number.",
        date:"#{field} debe tener el formato de fecha. (mm/dd/yyyy)",
        email:"#{field} debe tener formato de Email.",
        usd:"#{field} must be formatted as a US Dollar amount.",
        url:"#{field} debe tener formato de URL.",
        number:"#{field} solo puede contener numeros.",
        ...
        range:"#{field} solo acepta valores entre #{min} y #{max}.",

        // Value length messages:
        tooLong:"#{field} no puede contener mas de #{max} caracteres.",
        tooShort:"#{field} no puede contener menos de #{min} caracteres.",

        // Composition validators:
        nonHtml:"#{field} no puede contener etiquetas HTML.",
        alphabet:"#{field} contiene caracteres no reconocidos.",
        ...
        radioChecked:"El valor seleccionado es invalido.",
