   ...
   <div class="modal-dialog">
     <div class="modal-content">
       ...
       <div class="modal-body">
         <div role="form" onkeypress="return runScriptLogin(event)">
           <div class="form-group">
             ...
             <input type="text" class="form-control" id="user_login" name="user_login" placeholder="Introducir Email">
           </div>
           <div class="form-group">
       ...
       <div class="modal-footer">
         ...
         <p>¿No estás registrado? <a href="<?php echo "index.php?accion=user-add"; ?>"  data-target="#registro">Registrate!</a></p>
         <p>Contraseña <a data-toggle="modal" data-target="#lostpassdiv">perdida?</a></p>
       </div>
     </div>
   </div>
</div>
